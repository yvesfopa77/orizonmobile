...
enum BottomNavigationBarType {
  /// The [CustomBottomNavigationBar]'s [BottomNavigationBarItem]s have fixed width.
  fixed,
...
/// Refines the layout of a [CustomBottomNavigationBar] when the enclosing
...
/// To update from [CustomBottomNavigationBar] to [NavigationBar], you will
/// need to make the following changes.
///
/// 1. Instead of using [CustomBottomNavigationBar.items], which
...
///
/// 2. Instead of using [CustomBottomNavigationBar.onTap],
/// use [NavigationBar.onDestinationSelected], which is also
/// a callback that is called when the user taps on a
/// navigation bar item.
///
/// 3. Instead of using [CustomBottomNavigationBar.currentIndex],
...
///
/// ## Using [CustomBottomNavigationBar]
///
/// {@tool dartpad}
...
///
/// {@tool dartpad}
/// This example shows how you would migrate the above [CustomBottomNavigationBar]
...
/// {@tool dartpad}
/// This example shows a [CustomBottomNavigationBar] as it is used within a [Scaffold]
/// widget. The [CustomBottomNavigationBar] has four [BottomNavigationBarItem]
...
///
/// {@tool dartpad}
/// This example shows [CustomBottomNavigationBar] used in a [Scaffold] Widget with
...
class CustomBottomNavigationBar extends StatefulWidget {
  ...
  /// This flag is controlling how [CustomBottomNavigationBar] is going to use
